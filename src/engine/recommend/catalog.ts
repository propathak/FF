 ...
 *
 * Every recommendation is shown in full. Identity is captured at sign-in, so
 * withholding half the plan afterwards would ask the same person for the same
 * thing twice.
 */
...
export const RECOMMENDATION_CATALOG: Record<string, RecommendationTemplate> = {
  ...
  'geo.machine.ai_crawler_access': {
    ...
    horizon: 'now', impact: 'High', effort: 'Low',
  },
  ...
  'seo.index.https': {
    ...
    horizon: 'now', impact: 'High', effort: 'Medium',
  },
  ...
  'seo.index.csr_dependency': {
    ...
    horizon: 'now', impact: 'High', effort: 'High',
  },
  'seo.index.broken_pages': {
    ...
    horizon: 'now', impact: 'Medium', effort: 'Low',
  },
  ...
  'geo.entity.organization_schema': {
    ...
    horizon: '30d', impact: 'High', effort: 'Low',
  },
  'geo.entity.sameas': {
  ...
  'aeo.answer.direct_answer_proximity': {
    ...
    horizon: '30d', impact: 'High', effort: 'Medium',
  },
  'aeo.schema.faq': {
  ...
  'aeo.schema.answer_alignment': {
    ...
    horizon: '30d', impact: 'Medium', effort: 'Low',
  },
  ...
  'aeo.eeat.author_byline': {
    ...
    horizon: '30d', impact: 'Medium', effort: 'Medium',
  },
  'aeo.eeat.dates': {
  ...
  'seo.onpage.content_depth': {
    ...
    horizon: '30d', impact: 'Medium', effort: 'High',
  },
  'seo.perf.lcp': {
  ...
  'seo.onpage.meta_description': {
    ...
    horizon: '30d', impact: 'Low', effort: 'Low',
  },
  ...
  'geo.citation.third_party': {
    ...
    horizon: '90d', impact: 'High', effort: 'High',
  },
  ...
  'geo.content.comparisons': {
    ...
    horizon: '90d', impact: 'High', effort: 'Medium',
  },
  ...
  'geo.content.quotable': {
    ...
    horizon: '90d', impact: 'Medium', effort: 'Medium',
  },
  ...
  'aeo.coverage.intent_spread': {
    ...
    horizon: '90d', impact: 'Medium', effort: 'High',
  },
  ...
  'geo.machine.llms_txt': {
    ...
    horizon: '90d', impact: 'Low', effort: 'Low',
  },
